...
module.exports = {
    name: 'suggest',
    description: 'Suggest a feature or something to the developer.',
    emoji: '❔',
    ...
    run: async (client, message, args) => {
        try {
            ...
            const logChannel = client.channels.cache.get('1144186745227845712');
            ...
            const sankyuu = new MessageEmbed()
                ...
                .setDescription(
                    `Hey <@${message.author.id}>, thanks for your suggestion!\nYour suggestion has been sent to [**Olympus Development**](https://discord.gg/theolympus69) in <#1144186745227845712>.`
                )
                .setColor('#00FF00')
                .setTimestamp();
