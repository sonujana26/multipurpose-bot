...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        const supportServerLink = 'https://discord.gg/theolympus69'; // Replace with your support server link
        const websiteLink = 'https://krishnajana295.wixsite.com/sonujana'; // Replace with your website link
        
        const core = os.cpus()[0];
        const embed = new MessageEmbed()
            .setTitle(`OLYMPUS'S Stats`)
            .setURL(websiteLink)
