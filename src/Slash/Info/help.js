...
module.exports = {
    ...
    run: async (client, message, args) => {
        try {
            ...
            const supportServerLink = 'https://discord.gg/theolympus69';
            const githubLink = 'https://github.com/sonujana26';
            const instagram = 'https://www.instagram.com/sonujana.ig/';

            const embed = new MessageEmbed()
                .setTitle('Olympus Help Desk')
                .setThumbnail(client.user.displayAvatarURL({ size: 512 }))
                .setDescription(
                    `Please choose a category in the Dropdown menu!\n\nMade with 💖 and Discord.js\n\n[Support Server](${supportServerLink}) | [GitHub](${githubLink}) [Instagram](${instagram})`
                )
                .setColor(color);
